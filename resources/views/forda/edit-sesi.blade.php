...
@section('title', 'Edit Grup Koordinasi')

@section('content_header')
    <h1>Edit Waktu Pelaksanaan Welcome</h1>
@stop
        ...
        <div class="col-12">
            <div class="card elevation-2">
              <div class="card-header">
                <h1 class="card-title">Edit Waktu Pelaksanaan Welcome</h1>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                    <form method="POST" action="{{ route('forda.edit-sesi.store')}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="sesi_welcome">Waktu Pelaksanaan Welcome</label>
                                <input type="text" class="form-control" id="sesi_welcome"
                                    value="{{ $forda_peserta->tryoutForda->sesi_welcome }}" name="sesi_welcome"/>
                            </div>
                        </div>
                        <!-- /.card-body -->
