        ...
        <div class="col-12">
            <div class="card elevation-2">
              <div class="card-header">
                <h1 class="card-title">Edit Grup Koordinasi</h1>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                    <form method="POST" action="{{ route('forda.edit-grup.store')}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="grup_koordinasi">Link Grup Koordinasi</label>
                                <input type="text" class="form-control" id="grup_koordinasi"
                                    value="{{ $forda_peserta->tryoutForda->grup_koordinasi }}" name="grup_koordinasi"/>
                            </div>
                        </div>
                        <!-- /.card-body -->
