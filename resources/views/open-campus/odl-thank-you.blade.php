...
@section('open-campus-content')
  ...
  <section id="terima-kasih" class="container vh-100 d-flex justify-content-center align-items-center flex-column">
    ...
    <div class="row text-white text-center px-2 px-sm-5">
      <div class="col">
        <h2>
          Kamu telah terdaftar pada One Day Lecture Ini Lho ITS! 2022. Jangan lupa untuk terus memantau informasi menarik di sosial media Ini Lho ITS! 2022.
        </h2>
        <br>
        <h3>
          Link Zoom Meeting One Day Lecture Ini Lho ITS! 2022 dapat diakses melalui Dashboard Peserta.
        </h3>
        <br>
      </div>
    </div>
