        ...
        <div class="form-oprec">
            <div class="container-form p-3 p-md-5">
                <div class="row py-4 mx-0">
                    <h2 class="font-weight-bold text-center w-100">Pendaftaran Staff Divisi/Subdivisi Ini Lho ITS! 2022
                    </h2>
                </div>
                <div class="row py-2 w-100 text-center mx-0">
                    <p>Untuk penjelasan mengenai divisi/Subdivisi dapat diakses di link berikut :<a
                            href="http://intip.in/GuidebookEskalatorCita">http://intip.in/GuidebookEskalatorCita/</a>
                    </p>
                </div>
                <div class="row py-2 w-100 text-center mx-0">
                    <p>Form registrasi ini hanya dapat diisi <span class="text-danger">SEKALI</span>. Pastikan kamu
                        mengisi dengan jawaban yang benar.
                        Untuk pengguna Mac dan Iphone, jika mengalami kendala dapat melakukan registrasi melalui link
                        berikut: <a href="SiapJadiStaffILITS22Mac/">inilho.its.ac.id/SiapJadiStaffILITS22Mac/</a></p>
                </div>
                <form action="{{ route('oprec.store') }}" method="post" id="registration">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nrp') is-invalid @enderror" type="text" name="nrp"
                            value="{{ old('nrp') }}" id="nrp" placeholder="Masukkan NRP-mu">
                        @error('nrp')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kota_asal" value="{{ old('kota_asal') }}"
                            ...
                            placeholder="Masukkan kota/kabupaten asalmu">
                        @error('kota_asal')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea placeholder="Masukkan jawabanmu..."
                            class="form-control @error('apa_itu_ilits') is-invalid @enderror" name="apa_itu_ilits"
                            id="apa_itu_ilits" rows="3">{{ old('apa_itu_ilits') }}</textarea>
                        @error('apa_itu_ilits')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea placeholder="Masukkan jawabanmu..."
                            class="form-control @error('motivasi_ilits') is-invalid @enderror" name="motivasi_ilits"
                            id="motivasi_ilits" rows="3">{{ old('motivasi_ilits') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="pilihan_1" id="pilihan_1"
                            class="form-control @error('pilihan_1') is-invalid @enderror">
                    ...
                    <div class="form-group">
                        <label for="alasan_pilihan_1">Apa alasan dan motivasimu memilih divisi/subdivisi pada pilihan
                            pertamamu?</label>
                        <textarea placeholder="Masukkan jawabanmu..."
                            class="form-control @error('alasan_pilihan_1') is-invalid @enderror" name="alasan_pilihan_1"
                            id="alasan_pilihan_1" rows="3">{{old('alasan_pilihan_1')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="pilihan_2" id="pilihan_2"
                            class="form-control @error('pilihan_2') is-invalid @enderror">
                    ...
                    <div class="form-group">
                        <label for="alasan_pilihan_2">Apa alasan dan motivasimu memilih divisi/subdivisi atau jawaban
                            pada pilihan keduamu?</label>
                        <textarea placeholder="Masukkan jawabanmu..."
                            class="form-control @error('alasan_pilihan_2') is-invalid @enderror" name="alasan_pilihan_2"
                            id="alasan_pilihan_2" rows="3">{{old('alasan_pilihan_2')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('komitmen') is-invalid @enderror" name="komitmen"
                            id="komitmen">
                    ...
                    <div class="w-100 d-flex justify-content-center py-4">
                        <button class="btn btn-lg btn-primary" type="button" data-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Form registrasi ini hanya dapat diisi <span class="text-danger">SEKALI</span>. Pastikan kamu
                        mengisi dengan jawaban yang benar. Apakah kamu yakin untuk mengirim jawabanmu?</p>
                </div>
