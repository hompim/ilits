<div class="container px-5 py-5 position-relative carouselWithFloatingHeaderAndButton">
    <div class="top-0 px-5 py-3 floating-header position-absolute">
        <h2>{{ $headerTitle }}</h2>
    </div>
    <ol class="carousel-indicators position-absolute">
        @for($i = 0; $i < count($titles); $i++) <li data-target="#facilityCarousel" data-slide-to="{{ $i }}"
        ...
        <div class="carousel-inner">
            @for($i = 0; $i < count($titles); $i++) <div class="carousel-item @if($i == 0) active @endif">
                ...
                <div class="row">
                    ...
                    <div
                        class="px-5 text-left col-lg-6 left d-flex flex-column justify-content-between align-items-center">
