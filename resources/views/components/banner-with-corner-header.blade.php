<div class="contaiener py-4">
  <div class="position-relative banner" id="BannerWithCornerHeader">
    <h2 class="d-block py-1 px-3 py-sm-3 px-sm-4 text-start bg-light position-absolute header" style="color: #C17FE0">
        {{$title}}
    </h2>
    ...
    <div class="direction position-absolute">
      <a class="link" href="{{$href}}" target="_blank">
        <div class="rounded-circle d-flex justify-content-center align-items-center" style="background-color: #53EA90">
