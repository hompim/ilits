<div id="threeCardsContainerCarousel" class="carousel slide carousel-multi-item position-relative" data-ride="carousel">
    <div class="controls-top">
        <a class="btn-floating btn-floating-prev position-absolute" href="#threeCardsContainerCarousel" data-slide="prev">
            <span aria-hidden="true">
                <i class="text-white fa fa-3x fa-arrow-circle-o-left" aria-hidden="true"></i>
            </span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="btn-floating btn-floating-next position-absolute" href="#threeCardsContainerCarousel" data-slide="next">
            <span aria-hidden="true">
        ...
        @for($i = 0; $i < count($titles)/3; $i++) <div class="carousel-item @if($i == 0) active @endif">
            <div class="row">
                <div class="col-md-4 ">
                    <div class="p-3 overflow-hidden card card-container-1 ">
                ...
                <div class="clearfix col-md-4 d-none d-md-block ">
                    <div class="p-3 overflow-hidden card card-container-2 ">
                ...
                <div class="clearfix col-md-4 d-none d-md-block ">
                    <div class="p-3 overflow-hidden card card-container-3 ">
