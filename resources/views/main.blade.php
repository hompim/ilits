...
<section class="d-flex justify-content-center flex-column" id='jumbotron'>
  <article class="container text-white">
    <div class="col-12 col-md-8 col-lg-6">
      ...
      <p class="mb-5">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem, ipsum? Inventore eius
        dignissimos</p>
...
<section class="d-flex justify-content-center flex-column" id='general-info'>
  <article class="container text-center text-white">
    <div class="container">
      ...
      voluptatem quo neque' images='img/main/web-series.png, img/main/web-series.png, img/main/web-series.png' />
    </div>
  </article>
</section>
