...
return [
    ...
    */
    ...
    'logo' => '<b>Ini Lho ITS! 2022</b>',
    'logo_img' => 'ilits22.ico',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Shorten Link',
                    'url'  => 'admin/shortener/',
                    'active' => ['admin/shortener/', 'regex:@^admin/shortener/update/[0-9]@', 'regex:@^admin/shortener/delete/[0-9]@']
                ],
            ],
            'can' => ['admin-dashboard'],
        ],
